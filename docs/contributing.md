...
Contributions are welcome. `go-ruby-getoptlong/getoptlong` is built to a small set of non-negotiable
...
The library is in
[`github.com/go-ruby-getoptlong/getoptlong`](https://github.com/go-ruby-getoptlong/getoptlong). This documentation site is in
[`github.com/go-ruby-getoptlong/docs`](https://github.com/go-ruby-getoptlong/docs). Start from the
